...
const postRealEstate = async (req, res, next) => {
  try {
    const { location, streetName, city } = req.body;
    req.body.address = { location, streetName, city };
 ...
 * @returns {object} realEstates
 */
const getOwnerRealEstates = async (req, res, next) => {
  try {
 ...
 * @returns {object} realEstate
 */
const updatePropertyDetails = async (req, res, next) => {
  try {
    const {
      price,
      location,
    ...
    const updatedRealEstate = await RealEstate.findOneAndUpdate(
      { slug },
      {
        ...
        facing,
        category,
        address: { location, streetName, city },
      },
